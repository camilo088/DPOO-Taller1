...
public class CalculadoraEstadisticas
{
	...
	/**
     * Busca al atleta con el nombre dado y devuelve el país que representa.
     *
     * @param nombreAtleta El nombre del atleta que se busca.
     * @return El país representado por el atleta, o null si no se encuentra.
     */
    public Pais buscarPaisDeAtleta(String nombreAtleta) {
        Atleta atleta = buscarAtleta(nombreAtleta);
        if (atleta != null) {
            return atleta.darPais();
        }
        return null;
    }
