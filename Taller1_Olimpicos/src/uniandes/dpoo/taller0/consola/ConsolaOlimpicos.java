...
public class ConsolaOlimpicos
{
	...
	private void buscarPaisDeAtleta() {
		
		String nombre_atleta = input("Ingrese el nombre del atleta que le interesa");

        Pais pais = calculadora.buscarPaisDeAtleta(nombre_atleta);

        if (pais != null) {
            System.out.println("El atleta " + nombre_atleta + " representa al país " + pais.darNombre());
        } else {
            System.out.println("No se encontró información para el atleta: " + nombre_atleta);
        }
    }
